...
<li> <a href ="">Bears vs Pandas SVM, XGB, LGBM, Ensemble Method w/Noised-Dataset </a>  (ACC: 96.75 %) </li>
<li> <a href =""> Groundwater Quality Classification w/CatBoost </a> </li>

<li> <a href =""> (QSAR) Prediction Biological Activity w/CatBoost Implementation </a>  (MCC: 0.825) </li>

<li> <a href =""> (QSAR) Classification Activity of Inhibitors of EphA4 Receptor Antagonists (AID 689) w/CatBoost </a>  (MCC: 0.782) </li>

<li> <a href ="">Alive/Dead Diabetic Outcome Prediction with CatBoostClassifier w/CatBoost </a>  (ROC AUC Score: 0.77) </li>

<li> <a href ="">Pistachio Classification w/CatBoost </a>  (ROC AUC Score: 0.9) </li>


<li> <a href ="">Rain Prediction w/CatBoost and Conformal Prediction </a>  F1-Score:0.84 </li>
